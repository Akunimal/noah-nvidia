...
- Generated: 2026-09-07T09:53:56.305694Z
...
- [PASS] Clean working tree: no uncommitted changes (53 ms)
...
- [PASS] Repository whitespace: completed (46 ms)
- [PASS] Tracked secret scan: completed (407 ms)
- [PASS] Web typecheck: completed (2840 ms)
- [PASS] Web lint: completed (5994 ms)
- [PASS] Web tests: completed (2213 ms)
- [PASS] Web build: completed (5569 ms)
- [PASS] API tests: completed (4621 ms)
- [PASS] API compile check: completed (348 ms)
- [PASS] API deterministic smoke: completed (1272 ms)
- [PASS] OpenAPI export: completed (1411 ms)
- [PASS] OpenAPI is committed: completed (42 ms)
- [PASS] Promptfoo local offline evaluation: completed (9313 ms)
- [PASS] npm production audit: completed (2152 ms)
