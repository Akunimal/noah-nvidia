...
| 8 | Cutover y hardening del reviewer | URL abierta, Nebius efectivo desde el 2026-10-27, OpenCode2API desactivado, cuotas/fallback/CORS/cold start verificados | **En progreso · smoke limpio y pruebas deterministas cerrados; cutover live pendiente** |
| 9 | Entrega y freeze | README, Devpost, video público menor a 3 minutos, licencia, instrucciones de prueba, Graphify y release reproducible | **Paquete en inglés redactado · video/envío/freeze pendientes** |
...
- [x] El tour no aparece antes de completar o saltear explícitamente; se
      puede reabrir por tenant después de esa decisión.
